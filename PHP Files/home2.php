...
$con = mysqli_connect("127.0.0.1", "root", "yrk27242621", "mysql");
if (!isset($_SESSION['user_email'])) {
	...
	<body>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-3 col-sm-3 col-xs-12 left-sidebar" style="height:100%">

					<div class="input-group searchbox">
						<div class="input-group-btn">
							<a href="find_friends.php"><button class="btn btn-default search-icon" name="search_user" type="submit">Add new user</button></a>
						</div>
					</div>
					<div class="left-chat">
						<ul>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar" style="height:100%">
					<div class="row">
						...
						<div class="col-md-12 right-header">
							<div class="right-header-img">
								...
								<img src='<?php echo "$user_profile_image"; ?>' width=40 height=40 alt="Profile" />
							</div>
							<div class="right-header-detail">
								<form method="post">
									<p><?php echo "$username"; ?></p>
									<span><?php echo $total; ?> messages</span>&nbsp &nbsp
									<button name="logout" class="btn btn-danger alignbtn">Logout</button>
								</form>
								<?php
